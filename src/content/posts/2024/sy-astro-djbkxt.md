...
description: 作者决定让博客「挪窝」，此前一直用语雀文档在线写作，严格来说那更像笔记而非博客。文章记录了从犹豫到动手搭建的完整心路：一直在 Java+Vue、React+Golang、React+Node.js 等技术栈之间纠结，也担心自己产出不了高质量的技术博客，直到看了 oldj 大佬的博客才明白——博客最重要的不是华丽的页面，而是内容本身。经过博客园自定义与 Hexo 的尝试后，最终选择了 Astro。文章详细记录了使用 Astro 搭建博客系统的过程：项目初始化、目录结构、内容集合配置、组件化布局、以及部署上线等步骤，为同样想自己搭建博客的读者提供了完整参考。
pubDatetime: 2024-07-06 12:00:00
tags:
    - Astro
    - 前端
---
