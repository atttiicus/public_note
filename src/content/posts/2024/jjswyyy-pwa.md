---
title: 渐进式网页应用 PWA
description: PWA（Progressive Web App）即渐进式网页应用，它提供了一条让普通网站逐步过渡到 Web 应用的渐进式路线，而不是像早年那样激进地宣称取代本地 App。文章从两个角度理解「渐进式」：对开发者而言，渐进式改造可以降低站点转型的代价，逐步支持新技术；对技术本身而言，PWA 的能力也在不断演进——更好的设备特性支持、更流畅的动画、更快的加载速度，一步步补齐本地应用才有的体验。文章分析了 PWA 如何解决 Web 应用面临的留存与体验问题，并系统介绍了其核心技术（Service Worker、离线缓存、Web 推送、安装到桌面等），帮助读者判断自己的站点是否适合引入 PWA。
pubDatetime: 2024-09-27 13:30:00
tags:
    - 前端
---
