---
title: 美化 VSCode
description: VSCode 可以说是程序员无论使用哪个操作系统都会安装的编辑器，它最大的优势是丰富的插件市场与高度可自定义的配置，完全可以 DIY 出一个属于自己的「完美 IDE」。文章首先诚实地提醒：VSCode 严格来说不是专业 IDE，面对 JavaWeb 开发、C++ 桌面程序、游戏开发等大型项目，还是更推荐 IDEA、VisualStudio 等专业工具。随后进入正题——美化配置：推荐适合程序员的连字字体及其安装方法（包括安装后无法直接使用的解决方式），再逐步介绍主题搭配、图标主题、状态栏自定义等插件与配置项，让编辑器在视觉上焕然一新，同时保持流畅的使用体验。
pubDatetime: 2024-01-31 12:00:00
tags:
    - IDE
---
