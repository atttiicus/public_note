---
title: Web 性能分析
description: 页面是浏览器的核心，Chrome 开发者工具则是工程师调试页面的核心工具，熟练使用它能更深入地了解浏览器内部工作原理。文章作为性能模块的开篇，先对 DevTools 做整体介绍：与性能相关的网络面板、Performance 面板、内存面板，与调试页面相关的 Elements、Sources、Console 等面板，并推荐体验新功能的 Chrome Canary。随后重点深入网络面板：请求列表如何展示每个资源的大小、耗时、加载优先级，如何通过时间线分析 DNS 查询、连接建立、请求发送、等待响应、下载等各个阶段的耗时，从而快速定位网络瓶颈，为后续系统性的性能优化打下基础。
pubDatetime: 2024-12-05 13:30:00
tags:
    - 前端
    - 浏览器
    - 性能
---
页面是浏览器的核心，浏览器中的所有功能点都是服务于页面的，而 Chrome 开发者工具又是工程师调试页面的核心工具，所以在这个模块的开篇，我想先带你来深入了解下 Chrome 开发者工具。
