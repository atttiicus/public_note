---
title: 宏任务与微任务
description: 微任务在实时性与效率之间做了有效的权衡，已经被广泛使用——MutationObserver、Promise 以及基于 Promise 发展起来的大量技术都建立在微任务之上。文章从宏任务讲起：页面中渲染事件、用户交互、脚本执行、网络请求完成等任务都被放入消息队列，由事件循环系统依次取出执行，这些消息队列中的任务就是宏任务。随后重点剖析微任务：微任务队列如何在宏任务执行完毕后、浏览器渲染之前被清空，为什么微任务拥有更高的优先级，以及宏任务与微任务如何相互配合、取长补短。理解了这套调度机制，才能读懂异步代码的真实执行顺序，写出更高效的现代 JavaScript。
pubDatetime: 2024-08-19 13:30:00
tags:
    - 前端
    - JavaScript
---
...
![](https://blog.poetries.top/img/static/gitee/2019/11/41.png) ![](https://blog.poetries.top/img/static/gitee/2019/11/42.png)
