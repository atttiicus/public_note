---
title: 域名解析
description: DNS 的作用是把便于人类记忆的域名转换为计算机能处理的 IP 地址，作者坦言自己曾把它想象成一个部署在神秘机房里的「电话本」，直到了解世界根域名服务器的 ZONE 文件只有 2MB、甚至可以打印出来物理备份时，才对这套系统设计的优雅惊叹不已。文章从 DNS 作为透明多级分流系统的定位出发，详细讲解域名解析的完整过程：本地缓存、递归查询与迭代查询、各级域名服务器的协作与缓存机制，并讨论 DNS 对系统流量的重要影响。内容既有技术细节，又保留了一位工程师发现系统之美时的真诚感慨。
pubDatetime: 2023-05-25 12:00:00
tags:
    - 网络
---
